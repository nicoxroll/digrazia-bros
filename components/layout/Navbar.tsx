      ...
      >
        <div className="flex flex-col h-full p-8">
          <div className="flex justify-between items-center mb-12">
            <span className="font-serif text-2xl font-bold text-nude-500">
              Menu
            </span>
            <button
              onClick={() => setIsMobileMenuOpen(false)}
              className="p-2 text-nude-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
          ...
          <div className="flex flex-col gap-8 text-xl font-bold uppercase tracking-widest text-nude-500">
            ...
            <button
              ...
              className="text-left hover:text-pastel-clay transition-colors uppercase tracking-widest font-bold"
            >
              Contact
            </button>
          </div>
