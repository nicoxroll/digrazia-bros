...
export const ScrollingFashionMarquee: React.FC = () => {
  ...
  const images = [
    ...
    'https://images.unsplash.com/photo-1513519247388-193ad51c50bb?q=80&w=800&auto=format&fit=crop',
    'https://images.unsplash.com/photo-1533090161767-e6ffed986c88?q=80&w=800&auto=format&fit=crop',
    'https://images.unsplash.com/photo-1550254478-ead40cd82477?q=80&w=800&auto=format&fit=crop'
  ];
