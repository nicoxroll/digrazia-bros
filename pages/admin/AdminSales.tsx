...
const MOCK_SALES = [
  ...
  {
    id: "1002",
    customer: "Luca Guadagnino",
    product: "Marble Nesting Tables",
    price: 560,
    date: "Mar 10, 2024",
    status: "Processing",
  },
  {
    id: "1003",
    customer: "Monica Bellucci",
    product: "Ethereal Bed Frame",
    price: 1750,
    date: "Mar 08, 2024",
    status: "Commissioned",
  },
  {
    id: "1004",
    customer: "Ennio Morricone",
    product: "Rose Quartz Lamp",
    price: 240,
    date: "Mar 05, 2024",
    status: "Shipped",
  },
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
        <div>
          ...
          <p className="text-nude-300 font-medium tracking-widest uppercase text-[10px] mt-2">
            Historical studio transactions.
          </p>
        </div>
        <button className="px-8 py-3 bg-white border border-nude-100 rounded-full text-[10px] font-bold uppercase tracking-widest text-nude-400">
          Export Ledger
        </button>
      </div>
            ...
            <tbody className="divide-y divide-nude-50">
              {isLoading ? (
                ...
                paginatedSales.map((sale) => (
                  ...
                  >
                    <td className="px-4 lg:px-8 py-8 font-mono text-[10px] font-bold text-nude-200">
                      #{sale.id}
                    </td>
        ...
        footer={
          <div className="flex gap-3">
            <button
              ...
              className="px-6 py-3 bg-white border border-nude-100 rounded-full text-nude-400 font-bold uppercase tracking-widest hover:bg-nude-50 transition-colors"
            >
              Cancel
            </button>
            <button
              onClick={() => setEditingSale(null)}
              className="px-6 py-3 bg-nude-500 text-white rounded-full font-bold uppercase tracking-widest shadow-lg hover:bg-black transition-all"
            >
              Apply Update
            </button>
          </div>
      ...
      >
        <div className="space-y-6">
          <div className="p-6 bg-nude-50 rounded-2xl space-y-3">
            <p className="text-[10px] uppercase tracking-widest font-bold text-nude-300">
              Client Details
            </p>
            <h4 className="font-serif text-2xl text-nude-500 font-bold">
              {editingSale?.customer}
            </h4>
            <p className="text-sm text-nude-400">
              {editingSale?.product} • ${editingSale?.price?.toLocaleString()}
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <textarea
              placeholder="Add private studio observations..."
              className="w-full h-24 bg-nude-50 border-none rounded-2xl px-6 py-4 outline-none focus:ring-2 focus:ring-pastel-clay/20 resize-none"
            ></textarea>
          </div>
        </div>
      </Modal>
