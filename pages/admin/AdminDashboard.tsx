...
export const AdminDashboard: React.FC = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: "42",
      trend: "+5",
      color: "bg-pastel-sage/20",
    },
    {
      label: "Studio Inquiries",
      value: "158",
      trend: "High",
      color: "bg-pastel-rose/20",
    },
    {
    ...
    <div className="space-y-12 animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex gap-4">
          <button className="px-8 py-3 bg-white border border-nude-100 rounded-full text-[10px] font-bold uppercase tracking-widest text-nude-400 hover:bg-nude-50 transition-all">
            Export Report
          </button>
          <button className="px-8 py-3 bg-nude-500 text-white rounded-full text-[10px] font-bold uppercase tracking-widest shadow-lg hover:bg-black transition-all">
            New Piece
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {isLoading
          ...
          : stats.map((stat, i) => (
              <div
                key={i}
                className={`${stat.color} p-6 lg:p-8 rounded-[3rem] border border-nude-100 space-y-4 shadow-sm transition-transform hover:-translate-y-1 overflow-hidden`}
              >
                <p className="text-[10px] uppercase tracking-[0.3em] font-bold text-nude-300 truncate">
                  {stat.label}
                </p>
                <div className="flex flex-wrap items-end justify-between gap-2">
                  <h4 className="font-serif text-3xl lg:text-4xl font-bold text-nude-500 break-words">
                    {stat.value}
                  </h4>
                  <span className="text-[10px] font-bold text-pastel-clay shrink-0">
                    {stat.trend}
                  </span>
                </div>
              </div>
          ...
          <div className="flex-1 flex items-center justify-center gap-12">
            <div className="relative w-52 h-52">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-[10px] uppercase tracking-widest font-bold text-nude-200">
                  Total Pieces
                </span>
              ...
              {pieData.map((d, i) => (
                <div key={i} className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[10px] uppercase tracking-widest font-bold text-nude-400">
                      {d.name}
                    </span>
                    <span className="text-[11px] font-bold text-nude-500">
                      {d.value} items
                    </span>
                  </div>
                </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-white rounded-[4rem] p-12 border border-nude-100 shadow-sm space-y-8">
          ...
          <div className="space-y-6">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="flex items-center justify-between py-4 border-b border-nude-50 last:border-0"
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-nude-50 rounded-2xl flex items-center justify-center text-nude-300 font-bold border border-nude-100">
                    #
                  </div>
                  <div>
        ...
        <div className="bg-nude-500 rounded-[4rem] p-12 text-white space-y-8 shadow-2xl relative overflow-hidden">
          ...
          <p className="text-white/70 text-sm leading-relaxed relative z-10 font-light">
            You have 4 bespoke commissions pending review. The artisans in the
            Florence workshop have updated their completion timelines. Inventory
            for "Dining Room" pieces is below 15%.
          </p>
          <button className="w-full bg-white text-nude-500 py-4 rounded-full text-[10px] font-bold uppercase tracking-widest shadow-xl hover:bg-black hover:text-white transition-all relative z-10">
