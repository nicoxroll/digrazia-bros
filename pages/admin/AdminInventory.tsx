      ...
      <div className="space-y-8">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center bg-nude-50 rounded-2xl overflow-hidden border border-nude-100">
              <button
                ...
                className="px-4 py-4 hover:bg-nude-100 text-nude-500 transition-colors border-r border-nude-100 active:scale-95"
              >
                <svg
                  width="14"
                  height="14"
              ...
              <button
                ...
                className="px-4 py-4 hover:bg-nude-100 text-nude-500 transition-colors border-l border-nude-100 active:scale-95"
              >
                <svg
                  width="14"
                  height="14"
        ...
        <div className="space-y-4">
          <div className="flex flex-col gap-3 px-4">
            <label className="text-[10px] font-bold uppercase tracking-widest text-nude-300">
              Gallery Assets
            </label>
            ...
            {lastUploadedUrl && (
              <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-4 flex items-center gap-3 animate-in fade-in slide-in-from-top-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-emerald-700 truncate font-mono select-all">
                    {lastUploadedUrl}
                  </p>
                </div>
                <button
          ...
          <div className="grid grid-cols-3 sm:grid-cols-5 gap-3">
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover/img:opacity-100 transition-opacity flex flex-col items-center justify-center gap-2">
                  ...
                  <button
                    ...
                    className="p-2 bg-white rounded-full text-red-400 hover:text-red-600 shadow-2xl hover:scale-110"
                  >
                    <svg
                      width="14"
                      height="14"
            ...
            {isUrlInputOpen ? (
              <div className="aspect-square rounded-[2rem] border-2 border-nude-200 bg-nude-50 p-4 flex flex-col justify-center gap-3 animate-in zoom-in-95 duration-300">
                <label className="text-[8px] font-bold uppercase tracking-widest text-nude-300">
                  Image URL
                </label>
                <input
                  autoFocus
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 py-2 rounded-lg border border-nude-200 text-[10px] font-bold text-nude-400 hover:bg-white transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="flex-1 py-2 rounded-lg bg-pastel-clay text-white text-[10px] font-bold hover:bg-nude-500 transition-colors"
                  >
                    Add
                  </button>
                </div>
              ...
              >
                ...
                <span className="text-[9px] font-bold uppercase tracking-widest text-nude-200 group-hover:text-nude-400">
                  Add URL
                </span>
              </button>
            )}
        ...
        <div className="flex justify-end gap-4 pt-6 border-t border-nude-100">
          <button
            ...
            disabled={isSaving}
            className="px-10 py-4 bg-nude-500 text-white rounded-full font-bold uppercase tracking-widest shadow-xl hover:bg-black transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSaving
              ? "Saving..."
              : initialData
    ...
    <div className="space-y-12 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 relative">
          ...
          />
          <svg
            className="absolute left-4 top-1/2 -translate-y-1/2 text-nude-200"
            width="20"
            height="20"
            viewBox="0 0 24 24"
            fill="none"
      ...
      <div className="bg-white rounded-[2rem] lg:rounded-[3rem] shadow-sm border border-nude-100 overflow-hidden">
        ...
        <div className="w-full overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-nude-50 border-b border-nude-100">
              <tr>
                <th className="px-4 lg:px-8 py-6 text-[10px] font-bold uppercase tracking-widest text-nude-300">
                  Piece
                </th>
                <th className="px-4 lg:px-8 py-6 text-[10px] font-bold uppercase tracking-widest text-nude-300">
                  Category
                ...
                <th className="px-4 lg:px-8 py-6 text-[10px] font-bold uppercase tracking-widest text-nude-300 text-right">
                  Actions
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-nude-50">
              {isLoading ? (
                ...
                paginatedProducts.map((p) => (
                  ...
                  >
                    <td className="px-4 lg:px-8 py-8">
                      <div className="flex items-center gap-6">
                        ...
                        <span className="font-bold text-nude-500 text-base">
                          {p.name}
                        </span>
                      </div>
                    </td>
                    ...
                    <td className="px-4 lg:px-8 py-8">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          <span
                            className={`font-bold ${
                              p.stock < 5 ? "text-red-400" : "text-nude-500"
                            }`}
                          >
                            {p.stock} units
                          </span>
                          {p.stock < 5 && (
                            <span className="text-[8px] uppercase tracking-tighter text-red-300 font-bold">
                              Low Availability
                            </span>
                          )}
                        </div>
                    ...
                    <td className="px-4 lg:px-8 py-8 text-right">
                ...
                <tr>
                  <td
                    colSpan={5}
                    className="px-4 lg:px-8 py-20 text-center text-nude-300 italic"
                  >
        ...
        {totalPages > 1 && (
          <div className="p-8 bg-nude-50 border-t border-nude-100 flex items-center justify-between">
            <span className="text-[10px] uppercase tracking-widest font-bold text-nude-300">
        ...
        footer={
          <div className="flex gap-4">
            <button
              ...
              className="px-8 py-4 bg-white border border-nude-100 rounded-full text-nude-400 font-bold uppercase tracking-widest"
            >
              Cancel
            </button>
            <button
              ...
              className="px-8 py-4 bg-red-500 text-white rounded-full font-bold uppercase tracking-widest shadow-xl"
            >
              Confirm Removal
            </button>
          </div>
      ...
      >
        <div className="text-center space-y-6">
          ...
          <p className="text-xl text-nude-400 font-light italic">
            Are you certain you wish to remove{" "}
            <span className="font-bold text-nude-500 not-italic">
              "{deletingProduct?.name}"
            </span>{" "}
            from the master catalog? This action is permanent and will affect
            studio records.
          </p>
        </div>
      </Modal>
