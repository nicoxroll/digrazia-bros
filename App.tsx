...
const AppContent: React.FC = () => {
  ...
  return (
    <div
      className={`min-h-screen flex flex-col font-sans text-nude-500 bg-white selection:bg-pastel-clay selection:text-white ${
        isAdminView ? "flex-row" : ""
      }`}
    >
      <ScrollToTop />
        ...
        >
          <Routes>
            <Route
              path="/"
              element={
                <Landing onAddToCart={addToCart} contactRef={contactRef} />
              }
            />
            ...
            <Route
              path="/checkout"
              element={<Checkout cart={cart} onClear={() => setCart([])} />}
            />
            <Route
              path="/login"
              element={<LoginPage onLogin={setAdminUser} />}
            />
            ...
            <Route
              ...
              element={
                adminUser ? (
                  ...
                  <LoginPage onLogin={setAdminUser} />
                )
              }
            />
            <Route
